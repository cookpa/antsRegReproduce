...
## each experimental condition is in its own subfolder
experiment="doubleNoThreads"


readPairwiseLabelOverlaps <- function(experiment) {
...
##
##   plot - if T, make a plot with the results
##
